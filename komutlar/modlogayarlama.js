...
exports.help = {
    name: 'mod-log-ayarla',
    description: 'Mod log kanalını ayarlar. [Ayarlandığında Kapatılamaz]',
    usage: 'mod-log-ayarla <#kanal>'
}

//üsttekini komutlar/modlog.js açın ve içine yapıştırın

//alttakini ise bot.js sunucuyaözelayarlar/log.json açıp içine {} yazıp kapatın