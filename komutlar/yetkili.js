...
exports.run = (client, message, args) => {
    ...
    .addField('/çekiliş', 'açıklama/kullanım amacı') ('prefix+komut', 'açıklama/kullanım amacı') ('prefix+komut', 'açıklama/kullanım amacı') ('prefix+komut', 'açıklama/kullanım amacı')//ne kadar yetkili komutunuz varsa o kadar .addField('prefix+komut', 'açıklama/kullanım amacı') koyun
